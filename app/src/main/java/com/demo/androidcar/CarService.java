...
public class CarService extends AsyncTask<Void, Void, Void> {
    ...
    public CarService(Handler handler, String password) {
    ...
    protected Void doInBackground(Void... params) {
        Runnable run = new Runnable() {
            public void run() {
                ...
                try {
                    ...
                    Log.i(TAG, "Waiting for connect  doInBackground===============");
                    while (isTaskRunning) {
                        try {
        ...
        while (isTaskRunning) {
            try {
                ...
                }else if (data.equalsIgnoreCase(Command.PLAYSONG)) {
                    handler.obtainMessage(Command.MESSAGE_PLAYSONG).sendToTarget();
                }else if (data.equalsIgnoreCase(Command.PLAYPAUSE)) {
